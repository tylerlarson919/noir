             ...
             <StripeCheckoutShell clientSecret={clientSecret}>
              ...
              <div className="mb-8">
                <p className="text-center text-sm text-gray-500 dark:text-textaccent mb-3">
                  ...
                  {!expressReady && (
                    <div className="h-[46px] w-full bg-gray-200 dark:bg-white/10 animate-pulse rounded-sm mb-4">
                    </div>
                  )}
              ...
              {!formReady && (
                <div className="h-[420px] w-full bg-gray-200 dark:bg-white/10 animate-pulse rounded-sm">
                </div>
              )}
