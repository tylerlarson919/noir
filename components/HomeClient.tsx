    ...
    <div className="flex flex-col w-full h-full">
      ...
      <div className="relative h-[80vh] flex flex-row w-full items-center justify-start flex-grow">
        ...
        <button
          ...
          style={{
            backgroundImage:
              "url('https://res.cloudinary.com/dyujm1mtq/image/upload/v1745163797/TOPS_fcv680.webp')",
        ...
        <button
          ...
          style={{
            backgroundImage:
              "url('https://res.cloudinary.com/dyujm1mtq/image/upload/v1745163798/BOTTOMS__lk5qla.webp')",
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            width: '50%',
            height: '100%',
